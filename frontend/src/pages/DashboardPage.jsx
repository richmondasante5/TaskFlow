...
function DashboardPage() {
  ...
  // Load dashboard data whenever a valid token is available
  useEffect(() => {
    if (token) {
      loadDashboardData()
    }
  ...
  const loadDashboardData = async () => {
    try {
      // Clear previous error before making a new request
      setErrorMessage('')
      ...
      // Prevent runtime errors if backend returns unexpected data
      ...
      // Keep UI in a safe state if loading fails
      setTasks([])
        ...
        <div className="mt-8 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
          ...
          {tasks.length === 0 ? (
            ...
            <div className="divide-y divide-gray-100">
              ...
              {/* Only display the first five tasks */}
